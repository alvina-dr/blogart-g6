...
--
-- Table structure for table `COMMENTPLUS`
--
...
--
-- Dumping data for table `COMMENTPLUS`
--
...
--
ALTER TABLE `MOTCLE`
  MODIFY `numMotCle` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT for table `STATUT`
--
ALTER TABLE `STATUT`
  MODIFY `idStat` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- Constraints for table `COMMENTPLUS`
--
ALTER TABLE `COMMENTPLUS`
